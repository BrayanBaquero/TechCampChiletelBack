...
import com.chiletel.security.entity.UsuarioPrincipal;
...
public class JwtProvider {
	...
	@Value("${jwt.secret}")//Obtener secret de application.properties
	private String secret;
	@Value("${jwt.expiration}")//Obtener expiracion de application.properties
